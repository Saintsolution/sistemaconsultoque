  ...
  return (
    <section id="hero" className="relative w-full bg-gradient-to-br from-blue-500 via-blue-400 to-cyan-400 text-white overflow-hidden">
      <div className="w-full px-6 pt-20 pb-32 text-center">
        ...
        {/* Título original, focado no que o cliente busca */}
        ...
        <p className="text-lg md:text-2xl lg:text-3xl font-medium max-w-4xl mx-auto text-blue-100/95 leading-relaxed mb-14">
          Teleconsulta: Saúde na palma da sua mão, sem esperas.<br />
          Consultas 24 horas, 7 dias por semana, inclusive feriados.<br />
          Sem carência e sem limite de idade.
        </p>

        {/* CTAs Duplos: O foco é conversão */}
        <div className="flex flex-col md:flex-row justify-center gap-6 max-w-2xl mx-auto">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-widest">Plano Individual</span>
            <span className="text-3xl font-black my-1">R$ 33,00</span>
            <span className="text-xs font-bold uppercase opacity-90">mensais</span>
          </a>

          {/* Botão Familiar */}
          <a
            href="LINK_FAMILIAR_AQUI" 
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <span className="text-3xl font-black my-1">R$ 66,00</span>
            <span className="text-xs font-bold uppercase opacity-90">mensais</span>
          </a>
        </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 leading-[0]">
        <svg viewBox="0 0 1440 120" xmlns="http://www.w3.org/2000/svg" className="w-full h-24 lg:h-44" preserveAspectRatio="none">
