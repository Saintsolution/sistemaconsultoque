...
export function VideoAfiliados() {
  const [showButton, setShowButton] = useState(false);
  const [videoReady, setVideoReady] = useState(false);

  // Substitua pelo ID do seu vídeo de afiliados
  const wistiaId = "c7gl82cath"; 
  ...
  const goToAffiliate = () => {
    ...
    window.location.href = "/seja-afiliado" + searchParams;
  };
      ...
      <div className="w-[95%] max-w-lg md:max-w-xl lg:max-w-2xl relative shadow-2xl">
        ...
        {showButton && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/20 z-50">
            ...
            >
              <PlayIcon fill="white" /> QUERO SER AFILIADO
            </button>
          </div>
        )}
